...
export const columns: ColumnDef<Transaction>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="w-[90px]">{row.getValue("location")}</div>,
    enableSorting: true,
    enableHiding: false,
  },
  {
    ...
    cell: ({ row }) => <div className="w-[120px]">{row.getValue("transaction_id")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => <div className="w-[100px]">{row.getValue("license_plate")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="w-[120px]">{row.getValue("cellphone")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="w-[50px]">{row.getValue("base_rate")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="City Tax" />,
    cell: ({ row }) => <div className="w-[60px]">{row.getValue("city_tax")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
    accessorKey: "county_tax",
    header: ({ column }) => <DataTableColumnHeader column={column} title="County Tax" />,
    cell: ({ row }) => <div className="w-[80px]">{row.getValue("county_tax")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => <div className="w-[80px]">{row.getValue("service_fee")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
    accessorKey: "payment_gateway_fee",
    header: ({ column }) => <DataTableColumnHeader column={column} title="Processing Fee" />,
    cell: ({ row }) => <div className="w-[120px]">{row.getValue("payment_gateway_fee")}</div>,
    enableSorting: false,
    enableHiding: true,
  },
  {
