...
export const columns: ColumnDef<Reservation>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className='w-auto'>{row.getValue('hours')}</div>
    ),
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => (
      <div className='w-auto'>{row.getValue('phone_number')}</div>
    ),
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => (
      <div className='w-auto'>{row.getValue('total')}</div>
    ),
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => (
      <div className='w-auto'>{row.getValue('tax')}</div>
    ),
    enableSorting: false,
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => (
      <div className='w-auto'>{row.getValue('service_fee')}</div>
    ),
    enableSorting: false,
    enableHiding: true,
  },
